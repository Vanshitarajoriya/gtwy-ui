...
function LoadingSpinner({
  ...
  const embedCustomLogoUrl = useCustomSelector((state: any) =>
    state?.appInfoReducer?.embedUserDetails?.isEmbedUser
      ? state?.appInfoReducer?.embedUserDetails?.customLoadingLogoUrl || ""
      : ""
  );
  const logoUrl = customLogoUrl || embedCustomLogoUrl;
    ...
    >
      {logoUrl ? (
        <img
          src={logoUrl}
          alt="Loading"
          data-testid="custom-loading-logo"
